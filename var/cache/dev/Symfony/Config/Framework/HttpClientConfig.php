...
class HttpClientConfig 
{
    ...
    public function defaultOptions(array $value = []): \var\cache\dev\Symfony\Config\Framework\HttpClient\DefaultOptionsConfig
    {
        if (null === $this->defaultOptions) {
            $this->_usedProperties['defaultOptions'] = true;
            $this->defaultOptions = new \var\cache\dev\Symfony\Config\Framework\HttpClient\DefaultOptionsConfig($value);
     ...
     * @template TValue
     * @param TValue $value
     * @return \var\cache\dev\Symfony\Config\Framework\HttpClient\ScopedClientConfig|$this
     * @psalm-return (TValue is array ? \var\cache\dev\Symfony\Config\Framework\HttpClient\ScopedClientConfig : static)
     */
    public function scopedClient(string $name, mixed $value = []): \var\cache\dev\Symfony\Config\Framework\HttpClient\ScopedClientConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!isset($this->scopedClients[$name]) || !$this->scopedClients[$name] instanceof \var\cache\dev\Symfony\Config\Framework\HttpClient\ScopedClientConfig) {
            $this->_usedProperties['scopedClients'] = true;
            $this->scopedClients[$name] = new \var\cache\dev\Symfony\Config\Framework\HttpClient\ScopedClientConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('default_options', $value)) {
            $this->_usedProperties['defaultOptions'] = true;
            $this->defaultOptions = new \var\cache\dev\Symfony\Config\Framework\HttpClient\DefaultOptionsConfig($value['default_options']);
        ...
        if (array_key_exists('scoped_clients', $value)) {
            $this->_usedProperties['scopedClients'] = true;
            $this->scopedClients = array_map(function ($v) { return \is_array($v) ? new \var\cache\dev\Symfony\Config\Framework\HttpClient\ScopedClientConfig($v) : $v; }, $value['scoped_clients']);
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['scopedClients'])) {
            $output['scoped_clients'] = array_map(function ($v) { return $v instanceof \var\cache\dev\Symfony\Config\Framework\HttpClient\ScopedClientConfig ? $v->toArray() : $v; }, $this->scopedClients);
        }
