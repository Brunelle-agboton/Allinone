...
class TranslatorConfig 
{
     ...
     * @return \var\cache\dev\Symfony\Config\Framework\Translator\PseudoLocalizationConfig|$this
     * @psalm-return (TValue is array ? \var\cache\dev\Symfony\Config\Framework\Translator\PseudoLocalizationConfig : static)
     */
    public function pseudoLocalization(array $value = []): \var\cache\dev\Symfony\Config\Framework\Translator\PseudoLocalizationConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!$this->pseudoLocalization instanceof \var\cache\dev\Symfony\Config\Framework\Translator\PseudoLocalizationConfig) {
            $this->_usedProperties['pseudoLocalization'] = true;
            $this->pseudoLocalization = new \var\cache\dev\Symfony\Config\Framework\Translator\PseudoLocalizationConfig($value);
    ...
    */
    public function provider(string $name, array $value = []): \var\cache\dev\Symfony\Config\Framework\Translator\ProviderConfig
    {
        if (!isset($this->providers[$name])) {
            $this->_usedProperties['providers'] = true;
            $this->providers[$name] = new \var\cache\dev\Symfony\Config\Framework\Translator\ProviderConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('pseudo_localization', $value)) {
            $this->_usedProperties['pseudoLocalization'] = true;
            $this->pseudoLocalization = \is_array($value['pseudo_localization']) ? new \var\cache\dev\Symfony\Config\Framework\Translator\PseudoLocalizationConfig($value['pseudo_localization']) : $value['pseudo_localization'];
            unset($value['pseudo_localization']);
        }

        if (array_key_exists('providers', $value)) {
            $this->_usedProperties['providers'] = true;
            $this->providers = array_map(function ($v) { return new \var\cache\dev\Symfony\Config\Framework\Translator\ProviderConfig($v); }, $value['providers']);
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['pseudoLocalization'])) {
            $output['pseudo_localization'] = $this->pseudoLocalization instanceof \var\cache\dev\Symfony\Config\Framework\Translator\PseudoLocalizationConfig ? $this->pseudoLocalization->toArray() : $this->pseudoLocalization;
        }
