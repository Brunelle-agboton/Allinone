...
namespace var\cache\dev\Symfony\Config\Framework;
...
class MessengerConfig 
{
     ...
     * @template TValue
     * @param TValue $value
     * @return \var\cache\dev\Symfony\Config\Framework\Messenger\RoutingConfig|$this
     * @psalm-return (TValue is array ? \var\cache\dev\Symfony\Config\Framework\Messenger\RoutingConfig : static)
     */
    public function routing(string $message_class, array $value = []): \var\cache\dev\Symfony\Config\Framework\Messenger\RoutingConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!isset($this->routing[$message_class]) || !$this->routing[$message_class] instanceof \var\cache\dev\Symfony\Config\Framework\Messenger\RoutingConfig) {
            $this->_usedProperties['routing'] = true;
            $this->routing[$message_class] = new \var\cache\dev\Symfony\Config\Framework\Messenger\RoutingConfig($value);
    ...
    */
    public function serializer(array $value = []): \var\cache\dev\Symfony\Config\Framework\Messenger\SerializerConfig
    {
        if (null === $this->serializer) {
            $this->_usedProperties['serializer'] = true;
            $this->serializer = new \var\cache\dev\Symfony\Config\Framework\Messenger\SerializerConfig($value);
     ...
     * @template TValue
     * @param TValue $value
     * @return \var\cache\dev\Symfony\Config\Framework\Messenger\TransportConfig|$this
     * @psalm-return (TValue is array ? \var\cache\dev\Symfony\Config\Framework\Messenger\TransportConfig : static)
     */
    public function transport(string $name, string|array $value = []): \var\cache\dev\Symfony\Config\Framework\Messenger\TransportConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!isset($this->transports[$name]) || !$this->transports[$name] instanceof \var\cache\dev\Symfony\Config\Framework\Messenger\TransportConfig) {
            $this->_usedProperties['transports'] = true;
            $this->transports[$name] = new \var\cache\dev\Symfony\Config\Framework\Messenger\TransportConfig($value);
        } elseif (1 < \func_num_args()) {
    ...
    */
    public function bus(string $name, array $value = []): \var\cache\dev\Symfony\Config\Framework\Messenger\BusConfig
    {
        if (!isset($this->buses[$name])) {
            $this->_usedProperties['buses'] = true;
            $this->buses[$name] = new \var\cache\dev\Symfony\Config\Framework\Messenger\BusConfig($value);
        } elseif (1 < \func_num_args()) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('routing', $value)) {
            $this->_usedProperties['routing'] = true;
            $this->routing = array_map(function ($v) { return \is_array($v) ? new \var\cache\dev\Symfony\Config\Framework\Messenger\RoutingConfig($v) : $v; }, $value['routing']);
            unset($value['routing']);
        }

        if (array_key_exists('serializer', $value)) {
            $this->_usedProperties['serializer'] = true;
            $this->serializer = new \var\cache\dev\Symfony\Config\Framework\Messenger\SerializerConfig($value['serializer']);
            unset($value['serializer']);
        }

        if (array_key_exists('transports', $value)) {
            $this->_usedProperties['transports'] = true;
            $this->transports = array_map(function ($v) { return \is_array($v) ? new \var\cache\dev\Symfony\Config\Framework\Messenger\TransportConfig($v) : $v; }, $value['transports']);
        ...
        if (array_key_exists('buses', $value)) {
            $this->_usedProperties['buses'] = true;
            $this->buses = array_map(function ($v) { return new \var\cache\dev\Symfony\Config\Framework\Messenger\BusConfig($v); }, $value['buses']);
            unset($value['buses']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['routing'])) {
            $output['routing'] = array_map(function ($v) { return $v instanceof \var\cache\dev\Symfony\Config\Framework\Messenger\RoutingConfig ? $v->toArray() : $v; }, $this->routing);
        }
        ...
        if (isset($this->_usedProperties['transports'])) {
            $output['transports'] = array_map(function ($v) { return $v instanceof \var\cache\dev\Symfony\Config\Framework\Messenger\TransportConfig ? $v->toArray() : $v; }, $this->transports);
        }
