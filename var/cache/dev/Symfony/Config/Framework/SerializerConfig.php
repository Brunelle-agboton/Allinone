...
class SerializerConfig 
{
     ...
     * @default {"paths":[]}
    */
    public function mapping(array $value = []): \var\cache\dev\Symfony\Config\Framework\Serializer\MappingConfig
    {
        if (null === $this->mapping) {
            $this->_usedProperties['mapping'] = true;
            $this->mapping = new \var\cache\dev\Symfony\Config\Framework\Serializer\MappingConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('mapping', $value)) {
            $this->_usedProperties['mapping'] = true;
            $this->mapping = new \var\cache\dev\Symfony\Config\Framework\Serializer\MappingConfig($value['mapping']);
            unset($value['mapping']);
        }
