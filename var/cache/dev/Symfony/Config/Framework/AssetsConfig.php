...
class AssetsConfig 
{
    ...
    public function package(string $name, array $value = []): \var\cache\dev\Symfony\Config\Framework\Assets\PackageConfig
    {
        if (!isset($this->packages[$name])) {
            $this->_usedProperties['packages'] = true;
            $this->packages[$name] = new \var\cache\dev\Symfony\Config\Framework\Assets\PackageConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('packages', $value)) {
            $this->_usedProperties['packages'] = true;
            $this->packages = array_map(function ($v) { return new \var\cache\dev\Symfony\Config\Framework\Assets\PackageConfig($v); }, $value['packages']);
