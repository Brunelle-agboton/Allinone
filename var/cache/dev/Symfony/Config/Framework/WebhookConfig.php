...
class WebhookConfig 
{
    ...
    public function routing(string $type, array $value = []): \var\cache\dev\Symfony\Config\Framework\Webhook\RoutingConfig
    {
        if (!isset($this->routing[$type])) {
            $this->_usedProperties['routing'] = true;
            $this->routing[$type] = new \var\cache\dev\Symfony\Config\Framework\Webhook\RoutingConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('routing', $value)) {
            $this->_usedProperties['routing'] = true;
            $this->routing = array_map(function ($v) { return new \var\cache\dev\Symfony\Config\Framework\Webhook\RoutingConfig($v); }, $value['routing']);
            unset($value['routing']);
        }
