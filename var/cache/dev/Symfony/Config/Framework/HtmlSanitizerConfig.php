...
class HtmlSanitizerConfig 
{
    ...
    public function sanitizer(string $name, array $value = []): \var\cache\dev\Symfony\Config\Framework\HtmlSanitizer\SanitizerConfig
    {
        if (!isset($this->sanitizers[$name])) {
            $this->_usedProperties['sanitizers'] = true;
            $this->sanitizers[$name] = new \var\cache\dev\Symfony\Config\Framework\HtmlSanitizer\SanitizerConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('sanitizers', $value)) {
            $this->_usedProperties['sanitizers'] = true;
            $this->sanitizers = array_map(function ($v) { return new \var\cache\dev\Symfony\Config\Framework\HtmlSanitizer\SanitizerConfig($v); }, $value['sanitizers']);
