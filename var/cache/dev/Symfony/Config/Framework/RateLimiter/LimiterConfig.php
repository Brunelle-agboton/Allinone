...
namespace var\cache\dev\Symfony\Config\Framework\RateLimiter;
...
class LimiterConfig 
{
    ...
    */
    public function rate(array $value = []): \var\cache\dev\Symfony\Config\Framework\RateLimiter\LimiterConfig\RateConfig
    {
        if (null === $this->rate) {
            $this->_usedProperties['rate'] = true;
            $this->rate = new \var\cache\dev\Symfony\Config\Framework\RateLimiter\LimiterConfig\RateConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('rate', $value)) {
            $this->_usedProperties['rate'] = true;
            $this->rate = new \var\cache\dev\Symfony\Config\Framework\RateLimiter\LimiterConfig\RateConfig($value['rate']);
            unset($value['rate']);
        }
