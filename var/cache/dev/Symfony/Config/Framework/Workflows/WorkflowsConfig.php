...
namespace var\cache\dev\Symfony\Config\Framework\Workflows;
...
class WorkflowsConfig 
{
     ...
     * @return \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\AuditTrailConfig|$this
     * @psalm-return (TValue is array ? \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\AuditTrailConfig : static)
     */
    public function auditTrail(array $value = []): \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\AuditTrailConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!$this->auditTrail instanceof \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\AuditTrailConfig) {
            $this->_usedProperties['auditTrail'] = true;
            $this->auditTrail = new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\AuditTrailConfig($value);
    ...
    public function markingStore(array $value = []): \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\MarkingStoreConfig
    {
        if (null === $this->markingStore) {
            $this->_usedProperties['markingStore'] = true;
            $this->markingStore = new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\MarkingStoreConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    /**
     * @param ParamConfigurator|ParamConfigurator|mixed $value
     *
     * @return $this
     */
     ...
     * @template TValue
     * @param TValue $value
     * @return \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\PlaceConfig|$this
     * @psalm-return (TValue is array ? \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\PlaceConfig : static)
     */
    public function place(mixed $value = []): \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\PlaceConfig|static
    {
        ...
        return $this->places[] = new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\PlaceConfig($value);
    }

    /**
     * @template TValue
     * @param TValue $value
     * @return \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\TransitionConfig|$this
     * @psalm-return (TValue is array ? \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\TransitionConfig : static)
     */
    public function transition(mixed $value = []): \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\TransitionConfig|static
    {
        ...
        return $this->transitions[] = new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\TransitionConfig($value);
    }
    ...
    public function __construct(array $value = [])
    {
        if (array_key_exists('audit_trail', $value)) {
            $this->_usedProperties['auditTrail'] = true;
            $this->auditTrail = \is_array($value['audit_trail']) ? new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\AuditTrailConfig($value['audit_trail']) : $value['audit_trail'];
        ...
        if (array_key_exists('marking_store', $value)) {
            $this->_usedProperties['markingStore'] = true;
            $this->markingStore = new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\MarkingStoreConfig($value['marking_store']);
        ...
        if (array_key_exists('places', $value)) {
            $this->_usedProperties['places'] = true;
            $this->places = array_map(function ($v) { return \is_array($v) ? new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\PlaceConfig($v) : $v; }, $value['places']);
            unset($value['places']);
        }

        if (array_key_exists('transitions', $value)) {
            $this->_usedProperties['transitions'] = true;
            $this->transitions = array_map(function ($v) { return \is_array($v) ? new \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\TransitionConfig($v) : $v; }, $value['transitions']);
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['auditTrail'])) {
            $output['audit_trail'] = $this->auditTrail instanceof \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\AuditTrailConfig ? $this->auditTrail->toArray() : $this->auditTrail;
        }
        ...
        if (isset($this->_usedProperties['places'])) {
            $output['places'] = array_map(function ($v) { return $v instanceof \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\PlaceConfig ? $v->toArray() : $v; }, $this->places);
        }
        if (isset($this->_usedProperties['transitions'])) {
            $output['transitions'] = array_map(function ($v) { return $v instanceof \var\cache\dev\Symfony\Config\Framework\Workflows\WorkflowsConfig\TransitionConfig ? $v->toArray() : $v; }, $this->transitions);
        }
