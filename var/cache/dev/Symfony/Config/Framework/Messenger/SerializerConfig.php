...
class SerializerConfig 
{
    ...
    */
    public function symfonySerializer(array $value = []): \var\cache\dev\Symfony\Config\Framework\Messenger\Serializer\SymfonySerializerConfig
    {
        if (null === $this->symfonySerializer) {
            $this->_usedProperties['symfonySerializer'] = true;
            $this->symfonySerializer = new \var\cache\dev\Symfony\Config\Framework\Messenger\Serializer\SymfonySerializerConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('symfony_serializer', $value)) {
            $this->_usedProperties['symfonySerializer'] = true;
            $this->symfonySerializer = new \var\cache\dev\Symfony\Config\Framework\Messenger\Serializer\SymfonySerializerConfig($value['symfony_serializer']);
