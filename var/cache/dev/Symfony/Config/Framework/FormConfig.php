...
class FormConfig 
{
    ...
    */
    public function csrfProtection(array $value = []): \var\cache\dev\Symfony\Config\Framework\Form\CsrfProtectionConfig
    {
        if (null === $this->csrfProtection) {
            $this->_usedProperties['csrfProtection'] = true;
            $this->csrfProtection = new \var\cache\dev\Symfony\Config\Framework\Form\CsrfProtectionConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('csrf_protection', $value)) {
            $this->_usedProperties['csrfProtection'] = true;
            $this->csrfProtection = new \var\cache\dev\Symfony\Config\Framework\Form\CsrfProtectionConfig($value['csrf_protection']);
