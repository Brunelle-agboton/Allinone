...
class NotifierConfig 
{
    ...
    public function adminRecipient(array $value = []): \var\cache\dev\Symfony\Config\Framework\Notifier\AdminRecipientConfig
    {
        $this->_usedProperties['adminRecipients'] = true;

        return $this->adminRecipients[] = new \var\cache\dev\Symfony\Config\Framework\Notifier\AdminRecipientConfig($value);
    }
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('admin_recipients', $value)) {
            $this->_usedProperties['adminRecipients'] = true;
            $this->adminRecipients = array_map(function ($v) { return new \var\cache\dev\Symfony\Config\Framework\Notifier\AdminRecipientConfig($v); }, $value['admin_recipients']);
